...
export default function EditJobFormWrapper({
  ...
  // 編集モードではinitialDataを渡さない（JobForm内で既存データを取得する）
  // ただしformatsとdismissalReasonsは事前取得したものを使用
  return (
    <JobForm
      mode="edit"
      jobId={jobId}
