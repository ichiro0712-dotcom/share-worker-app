...
export default function NewTemplatePage() {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (formData.images.length + result.validFiles.length <= 3) {
  ...
  const handleAttachmentUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (formData.attachments.length + result.validFiles.length <= 3) {
  ...
  const handleDresscodeImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (formData.dresscodeImages.length + result.validFiles.length <= 3) {
