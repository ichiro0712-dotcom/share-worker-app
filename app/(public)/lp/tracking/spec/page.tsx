    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">LPトラッキング仕様</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="space-y-4 text-gray-700">
            <div>
              <h3 className="font-medium text-gray-900 mb-2">トラッキングスクリプト</h3>
              <p className="text-sm">
                各LPページに<code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">/lp/tracking.js</code>が
                読み込まれ、ユーザーの行動を自動で計測します。
              </p>
            </div>
            <div>
              <h3 className="font-medium text-gray-900 mb-2">セッションID</h3>
              <p className="text-sm">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-2">キャンペーンコード</h3>
              <p className="text-sm">
                URLパラメータ<code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">?c=xxx</code>または
                UTMパラメータ（utm_source, utm_campaign等）から広告媒体を識別します。
                7日間localStorageに保存され、会員登録時に紐付けられます。
              </p>
            </div>
            <div>
              <h3 className="font-medium text-gray-900 mb-2">データ送信</h3>
              <p className="text-sm">
          ...
          <div className="space-y-6">
            ...
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium text-gray-900">PV（ページビュー）</h3>
              </div>
            ...
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium text-gray-900">セッション</h3>
              </div>
              <p className="text-sm text-gray-700">
            ...
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium text-gray-900">イベント（CTAクリック）</h3>
              </div>
              <p className="text-sm text-gray-700">
                LINE登録ボタン等のCTAボタンがクリックされた回数。
                <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">.btn-line-cta</code>クラスを持つ要素、
            ...
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center gap-2 mb-2">
                <Target className="w-4 h-4 text-gray-500" />
                <h3 className="font-medium text-gray-900">イベントCTR</h3>
              </div>
              <p className="text-sm text-gray-700">
            ...
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center gap-2 mb-2">
                <Activity className="w-4 h-4 text-gray-500" />
                <h3 className="font-medium text-gray-900">登録</h3>
              </div>
            ...
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center gap-2 mb-2">
                <Target className="w-4 h-4 text-gray-500" />
                <h3 className="font-medium text-gray-900">登録率</h3>
              </div>
              <p className="text-sm text-gray-700">
            ...
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium text-gray-900">スクロール到達率</h3>
              </div>
              <p className="text-sm text-gray-700 mb-2">
            ...
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium text-gray-900">滞在時間達成率</h3>
              </div>
              <p className="text-sm text-gray-700 mb-2">
            ...
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center gap-2 mb-2">
                <Clock className="w-4 h-4 text-gray-500" />
                <h3 className="font-medium text-gray-900">セクション別滞在時間</h3>
              </div>
              <p className="text-sm text-gray-700">
                <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">data-section-id</code>属性を持つ
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left font-medium text-gray-700">条件</th>
                  <th className="px-4 py-3 text-left font-medium text-gray-700">意味</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <td className="px-4 py-3 font-medium">Level 0</td>
                  <td className="px-4 py-3 text-gray-600">5秒未満の滞在</td>
                  <td className="px-4 py-3 text-gray-600">直帰・即離脱</td>
                </tr>
                <tr className="bg-purple-50">
                  <td className="px-4 py-3 font-medium text-purple-700">Level 1</td>
                  <td className="px-4 py-3 text-gray-600">5秒以上滞在</td>
                  <td className="px-4 py-3 text-gray-600">最低限の興味</td>
                </tr>
                <tr className="bg-purple-50">
                  <td className="px-4 py-3 font-medium text-purple-700">Level 2</td>
                  <td className="px-4 py-3 text-gray-600">10秒以上滞在</td>
                  <td className="px-4 py-3 text-gray-600">一定の関心</td>
                </tr>
                <tr className="bg-purple-100">
                  <td className="px-4 py-3 font-medium text-purple-800">Level 3</td>
                  <td className="px-4 py-3 text-gray-600">10秒以上 + 50%スクロール</td>
                  <td className="px-4 py-3 text-gray-600">内容を読んでいる</td>
                </tr>
                <tr className="bg-purple-100">
                  <td className="px-4 py-3 font-medium text-purple-800">Level 4</td>
                  <td className="px-4 py-3 text-gray-600">10秒以上 + 75%スクロール</td>
                  <td className="px-4 py-3 text-gray-600">高い興味を持っている</td>
                </tr>
                <tr className="bg-purple-200">
                  <td className="px-4 py-3 font-medium text-purple-900">Level 5</td>
                  <td className="px-4 py-3 text-gray-600">10秒以上 + 90%スクロール</td>
                  <td className="px-4 py-3 text-gray-600">非常に強い興味・検討中</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        {/* CTA Comparison */}
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">CTAクリック有無による比較</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Data Layer */}
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">GTM/Google Analytics連携</h2>
          <p className="text-gray-700 mb-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <p className="text-sm font-medium text-gray-900 mb-2">プッシュされるイベント:</p>
            <ul className="text-sm text-gray-600 list-disc list-inside space-y-1">
              <li><code className="bg-gray-100 px-1 rounded">lp_pageview</code> - ページ表示</li>
              <li><code className="bg-gray-100 px-1 rounded">lp_scroll</code> - スクロール到達</li>
              <li><code className="bg-gray-100 px-1 rounded">lp_dwell</code> - 滞在時間達成</li>
              <li><code className="bg-gray-100 px-1 rounded">lp_cta_click</code> - CTAクリック</li>
              <li><code className="bg-gray-100 px-1 rounded">lp_engagement</code> - エンゲージメントレベル達成</li>
            </ul>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium text-gray-900">有効なLP</h3>
              </div>
              <ul className="text-sm text-gray-600 list-disc list-inside space-y-1">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium text-gray-900">停止中のLP</h3>
              </div>
              <ul className="text-sm text-gray-600 list-disc list-inside space-y-1">
