/**
 * @spec    docs/06_UI_BEHAVIOR_SPEC.md §1.2-1.3 (サイドバー + チャット欄)
 * @related knowledge/ANTI_PATTERNS.md §12 (prefill クリア)
 *
 * チャット + サイドバー + Canvas 統合 (~1700 行)。
 *
 * 重要:
 * - chatPrefill は送信時に setChatPrefill(null) でクリア必須 (ANTI_PATTERNS §12)
 * - discardEditTrigger++ でチャット送信時に Canvas の未保存編集を破棄
 * - Canvas オープン時に prevCanvasOpenRef で 1 回だけサイドバー自動折り畳み
 */
