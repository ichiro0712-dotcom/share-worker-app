/**
 * @spec    docs/02_DATA_MODEL.md (AdvisorChatMessage)
 * @related knowledge/BUG_FIX_PLAYBOOK.md #1 (Context Freeze バグ)
 * @related knowledge/ANTI_PATTERNS.md §15
 *
 * 重要:
 * - getRecentMessagesForOrchestrator: orderBy 'desc' + reverse() で「最新 N 件を時系列順」で返す
 * - 'asc' + take は「最古 N 件」になり、N 超のセッションで新指示が LLM に渡らない
 */
