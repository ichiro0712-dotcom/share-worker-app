...
| # | タスク | 詳細 |
|---|--------|------|
| 3.1.1 | ページ作成 | 勤怠詳細画面を新規作成 |
| 3.1.2 | Server Action追加 | `getAttendanceDetail`関数を追加 |
| 3.1.3 | UI実装 | 勤務情報、打刻情報、申請情報、却下理由を表示 |
| 3.1.4 | 再申請ボタン | 却下時に再申請ページへのリンクを表示 |
...
Phase 3 ────────────────────────────────────────────────
        ▼
  3.1 getAttendanceDetail Server Action作成
        │
        ▼
  3.2 勤怠詳細画面 作成
        │
