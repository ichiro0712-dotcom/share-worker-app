...
**計算例（17:00〜翌9:00、休憩1時間、時給1,000円）:**

```
【時間帯分類（休憩控除前）】
├─ 通常:     5時間（17:00-22:00）
├─ 深夜:     3時間（22:00-01:00）← ここまでで8時間
├─ 深夜残業: 4時間（01:00-05:00）
└─ 通常残業: 4時間（05:00-09:00）
...
【給与計算】
① ベース給与: 15時間 × ¥1,000 = ¥15,000
② 残業手当:   7時間 × ¥250   = ¥1,750（深夜残業3h + 通常残業4h）
③ 深夜手当:   6時間 × ¥250   = ¥1,500（深夜3h + 深夜残業3h）
─────────────────────────────────────
   合計:                        ¥18,250
```
...
| 2026-01-21 | 給与計算ロジック更新。休憩時間の控除ルール（セクション9.3）を追加。最も単価の高い時間帯から優先的に控除する仕様を明記。 |
