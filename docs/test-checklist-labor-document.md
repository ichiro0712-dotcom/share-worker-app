...
- **管理者**: admin@sworks.co.jp / admin123
...
| 2-3 | 面接ありで不採用の場合 | 「不採用」と表示される（キャンセルではなく） | |
...
| 5-14 | フッター | 労働基準法15条の記載とS WORKS発行が表示される | |
...
| # | テスト項目 | 期待結果 | OK/NG |
|---|-----------|---------|-------|
| 9-1 | 面接なし求人に応募 | 応募と同時にマッチング、チャットに通知が届く | |
| 9-2 | 面接あり求人で採用 | 管理者が「採用」に変更後、チャットに通知が届く | |
