// 都道府県と市区町村のデータ（主要な市区町村を含む）
// 全国約1700自治体から主要な市区町村を抽出
...
// 都道府県ごとの市区町村データ
export const PREFECTURE_CITIES: Record<Prefecture, string[]> = {
  '北海道': [
  ...
  '栃木県': [
    ...
    '真岡市', '大田原市', '矢板市', '那須塩原市', 'さくら市', '那須烏山市', '下野市'
  ],
  '群馬県': [
...
// 市区町村から都道府県を逆引きする関数
export function getPrefectureByCity(city: string): Prefecture | null {
  for (const [prefecture, cities] of Object.entries(PREFECTURE_CITIES)) {
    if (cities.includes(city)) {
      return prefecture as Prefecture;
    }
  }
  return null;
}
...
// 都道府県の市区町村を取得する関数
export function getCitiesByPrefecture(prefecture: Prefecture): string[] {
  return PREFECTURE_CITIES[prefecture] || [];
}
